# Contributing to Agent Chorus

Thanks for helping improve Agent Chorus.
...
6. If core behavior/docs/contracts change, refresh the local context pack with `chorus agent-context seal` (or `build`).
